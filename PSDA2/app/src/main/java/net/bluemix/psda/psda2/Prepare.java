...
public class Prepare extends ActionBarActivity {

    //declaration of widgets in layout
    Button guidelines, firstaid, prepare, addkit;
    TextView line,line1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addkit = (Button) findViewById(R.id.addkit);
        ...
        prepare.setBackgroundColor(Color.RED);
        ...
        firstaid.setOnClickListener( new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Prepare.this, Firstaid.class));
                finish();
            }
        });

        //on clicking  guideline

        //on clicking firstaid button
        addkit.setOnClickListener( new OnClickListener() {
            @Override
            public void onClick(View v) {
                // TODO Auto-generated method stub
                startActivity(new Intent(Prepare.this, Addkit.class));
                finish();
            }
        });
        ...
        guidelines.setOnClickListener( new OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                startActivity(new Intent(Prepare.this, Guidelines.class));
                finish();
            }
        });
